    ...
    <div class="row-fluid">
        <div class="span9 app-config-description">
            <div class="app-config-description-inner text-dark">
                ...
                tariffs, <strong class="text-dark">Off Peak</strong>, <strong class="text-dark">Shoulder</strong> and <strong class="text-white">Peak</strong>, costing <strong class="text-white">16.5c/kWh</strong>, <strong class="text-white">25.3c/kWh</strong> and <strong class="text-white">59.4c/kWh</strong> respectively, they
                are specified as:</p>
